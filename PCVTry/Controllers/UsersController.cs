    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var user = await _context.User
                .FirstOrDefaultAsync(m => m.UserLogId == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("Username,Password,UserLogId")] User user)
        {
        ...
        {
            return _context.User.Any(e => e.UserLogId == id);
        }
    }
}
